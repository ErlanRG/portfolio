const ExperienceCard = ({ period, title, details }) => {
  return (
    <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-lg shadow-xl hover:bg-cat-surface0 transition-transform duration-300 ease-in-out transform hover:scale-105 group">
      {/* Time */}
      <div className="w-full sm:w-40 flex-shrink-0 text-center sm:text-left">
